...
const x = window.matchMedia("(min-width: 540px)")
  if (!y.matches)  { new Swiper('.nav-swiper', {
    pagination: {
...
if (!x.matches)  { new Swiper('.brands-swiper', {
  pagination: {
    el: '.swiper-pagination',
  },
  navigation: {
...
if (!x.matches)  { new Swiper('.repairs-swiper', {
  pagination: {
    el: '.swiper-pagination',
  },
  navigation: {
...
if (!x.matches)  { new Swiper('.price-swiper', {
  pagination: {
    el: '.swiper-pagination',
  },
  navigation: {
